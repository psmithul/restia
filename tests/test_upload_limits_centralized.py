...
_LIMITS = {
    ...
    "PROJECT_ATTACHMENT_MAX_BYTES": ("ODYSSEUS_PROJECT_ATTACHMENT_MAX_BYTES", 50 * 1024 * 1024),
    "PROJECT_STORAGE_MAX_BYTES": ("ODYSSEUS_PROJECT_STORAGE_MAX_BYTES", 5 * 1024 * 1024 * 1024),
    "PROJECT_OWNER_STORAGE_MAX_BYTES": ("ODYSSEUS_PROJECT_OWNER_STORAGE_MAX_BYTES", 50 * 1024 * 1024 * 1024),
    "PROJECT_GLOBAL_STORAGE_MAX_BYTES": ("ODYSSEUS_PROJECT_GLOBAL_STORAGE_MAX_BYTES", 200 * 1024 * 1024 * 1024),
    "PROJECT_MAX_PROJECTS_PER_OWNER": ("ODYSSEUS_PROJECT_MAX_PROJECTS_PER_OWNER", 200),
    "PROJECT_MAX_STAGES_PER_PROJECT": ("ODYSSEUS_PROJECT_MAX_STAGES_PER_PROJECT", 50),
    "PROJECT_MAX_ACTIVITY_PER_PROJECT": ("ODYSSEUS_PROJECT_MAX_ACTIVITY_PER_PROJECT", 20_000),
    "PROJECT_MAX_ACTIVE_ITEMS": ("ODYSSEUS_PROJECT_MAX_ACTIVE_ITEMS", 2_000),
    "PROJECT_MAX_ITEMS": ("ODYSSEUS_PROJECT_MAX_ITEMS", 10_000),
    "PROJECT_MAX_CHECKLIST_ITEMS_PER_ITEM": ("ODYSSEUS_PROJECT_MAX_CHECKLIST_ITEMS_PER_ITEM", 500),
    "PROJECT_MAX_COMMENTS_PER_ITEM": ("ODYSSEUS_PROJECT_MAX_COMMENTS_PER_ITEM", 1_000),
    "PROJECT_MAX_ATTACHMENTS_PER_ITEM": ("ODYSSEUS_PROJECT_MAX_ATTACHMENTS_PER_ITEM", 200),
    "PROJECT_MAX_ATTACHMENTS_PER_PROJECT": ("ODYSSEUS_PROJECT_MAX_ATTACHMENTS_PER_PROJECT", 5_000),
...
def test_routes_import_from_upload_limits_not_local_defs():
    ...
    forbidden = {
        ...
        "src/project_storage.py": ["PROJECT_ATTACHMENT_MAX_BYTES = 50 * 1024 * 1024"],
        "routes/project_routes.py": [
            "PROJECT_STORAGE_MAX_BYTES = 5 * 1024 * 1024 * 1024",
            "PROJECT_MAX_ATTACHMENTS_PER_ITEM = 200",
            "PROJECT_MAX_ATTACHMENTS_PER_PROJECT = 5_000",
        ],
    }
    ...
    imports = {
        ...
        "src/project_storage.py": "PROJECT_ATTACHMENT_MAX_BYTES",
        "routes/project_routes.py": "PROJECT_STORAGE_MAX_BYTES",
    }
