...
from src.auth_helpers import DEFAULT_LOCAL_OWNER, require_user, resolved_request_owner
...
def _concrete_owner(request: Request) -> str:
...
def _ensure_planner_calendar(db, owner: str) -> CalendarCal:
    owner = owner or DEFAULT_LOCAL_OWNER
...
def setup_planner_routes() -> APIRouter:
    ...
    async def run_planner(request: Request, body: PlannerRequest):
        ...
        concrete_owner = _concrete_owner(request)
