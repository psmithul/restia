        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "linked_entity_ids": {"type": "array", "maxItems": 50, "items": {"type": "string", "minLength": 1, "maxLength": 255}, "description": "Owner-scoped Life Graph entity IDs to link to the event, such as a person, project, note, file, previous meeting, decision, or follow-up task."},
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "utc_offset_minutes": {"type": "integer", "minimum": -840, "maximum": 840, "description": "Required for action=today. Signed minutes local time is ahead of UTC, for example 330 for India."},
